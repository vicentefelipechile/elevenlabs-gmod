...
local function pError(msg)
    MsgC( COLOR_WHITE, "[", COLOR_CYAN, "Elevenlabs", COLOR_WHITE, "] ", "#", debug.getinfo(4, "Sl")["currentline"], " - " )
    MsgC( COLOR_STATE, COLOR_STATE )
...
local HTTPcode = {
    ...
    [401] = function() pError("401 - Unauthorized")
        ...
        eMsg("Look at this page for more info: https://docs.elevenlabs.io/api-reference/text-to-speech")
    end,
    ...
    [429] = function() pError("429 - Rate limit reached for requests") pMsg("This error message indicates that you have hit your assigned rate limit for the API") end,
...
function Elevenlabs.GetStatusDescription(code)
    local FuncStatus = HTTPcode[code] or function() MsgC(code, "\n") end
    FuncStatus()
end